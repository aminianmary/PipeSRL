      ...
      //      for (String feat:leftsiblingfeats.split("|"))
       //         features[index++] = pchildwset + "_" + feat;
        ...
        //        features[index++] = pchildwset + "_" + feat;
            ...
            //pw + aw + apos
            features[index++] = plem + "_" + aw + "_" + apos;
            features[index++] = plem + "_" + aw + "_" + adeprel;
            features[index++] = ppos + "_" + apos + "_" + adeprel;
            features[index++] = pdeprel + "_" + apos + "_" + adeprel;
            features[index++] = pchilddepset + "_" + apos + "_" + adeprel;
            features[index++] = pchilddepset + "_" + apos+ "_" + adeprel;
            features[index++] = pchildwset + "_" + aw + "_" + adeprel;
            features[index++] = plem + "_" + apos + "_" + adeprel;
        }
